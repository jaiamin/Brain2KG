...
if __name__ == '__main__':
    ...
    parser.add_argument("--relations", help="Ontology relations string, separated by commas")
    parser.add_argument("--few_shot_examples_file_path", help='Path to few-shot examples for defining relations')
    parser.add_argument("--ontology_triplets", help="Triplets list of lists, in string form")
    ...
    ontology_triplets = args.ontology_triplets
    model = args.model
